...
/* 
let bottom = Number(prompt("밑변 길이"));
let height = Number(prompt("높이 길이"));
let triangle_area = bottom * height / 2;
console.log(`삼각형의 넓이는 ${triangle_area}`); 
*/
...
/*
let C_tem = Number(prompt("섭씨 온도"));
let F_tem = (C_tem * 9 / 5) + 32;
console.log(`섭씨온도 ${C_tem}는 화씨온도${F_tem}`);
*/
...
/*
let year1 = Number(prompt("태어난 연도"));
let age1 = 2025 - year1;
console.log(`${year1}년 생의 나이는 ${age1}`);
*/
...
/* 
let height4 = Number(prompt("키"));
let weight4 = Number(prompt("몸무게"));
let BMI = weight4 / ( height4 * height4 * 0.0001);
console.log(`키 ${height4}cm, 몸무게 ${weight4}kg의 BMI는 ${BMI}`)
*/
...
let role = ID == 'admin' || Email == 'admin@test.com' ? "관리자" : "일반 사용자"; 
console.log(role)
*/
...
/* 70~80에 대한 grade가 없어요!!!!*/

/*
let point = Number(prompt("당신의 점수는"));
let grade = 점수 >= 90 ? "A" : 점수 >= 80 ? "B" : "C";

document.write(`${point}의 학점은 ${grade}`);
*/
...
/*
let age2 = Number(prompt("당신의 나이는?"));
let target = age2 >= 20 && age2 <=29 ? "이벤트 대상입니다." : "이벤트 대상이 아닙니다." ;
console.log(target);
*/
...
let LastName = waitingList[lastIndex];
