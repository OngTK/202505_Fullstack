...
*/
const person1 = { name: '옹태경', age: 31, city: "경기도 부천시" };
console.log(person1);

/* =====================
예제 2: 객체의 값(Value) 출력하기
다음과 같은 book 객체가 있습니다. 
반복문을 사용하여 이 객체의 모든 값 을 하나씩 콘솔에 출력하시오.
*/
const book = {
...
const values2 = Object.values(book) // 객체의 값만 배열로 변환
console.log(values2)
...
person3.email = "kimcode@gmail.com";
delete person3.age;
console.log(person3);
...
const value4 = product4.price * product4.stock;
console.log(`총 자산 가치 : ${value4}`);

/* =====================
예제 5: 대괄호 표기법 사용하기
다음 user 객체가 있습니다. 
대괄호 표기법을 사용하여 job-title 속성의 값('개발자')을 콘솔에 출력하시오.
*/
const user = {
    name: '김코딩',
    'job-title': '개발자'
...
const product9 = Object.keys(inventory);
const qty9 = Object.values(inventory);

for (let i = 0; i < product9.length; i++) {
    if (qty9[i] < 10) {
        console.log(product9[i]);
    };
};
...
const TableTitle = Object.keys(response.data[1])

document.write(`<table> <tr>`);
for (let i = 1; i < TableTitle.length; i++) {
    document.write(` <th> ${TableTitle[i]}  </th> `);
}
